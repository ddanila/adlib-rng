...
const opl_instr_t OPL_INSTR_KICK_FM = {
    /* mod */ { 0x01, 0x00, 0xF8, 0x66, 0x00 },
    /* car */ { 0x01, 0x00, 0xF8, 0x66, 0x00 },
    0x00
};

const opl_instr_t OPL_INSTR_SNARE_FM = {
    /* mod */ { 0x0E, 0x00, 0xF8, 0x47, 0x03 },
    /* car */ { 0x0F, 0x00, 0xF8, 0x47, 0x03 },
    0x00
};

const opl_instr_t OPL_INSTR_HAT_FM = {
    /* mod */ { 0x0F, 0x00, 0xFA, 0x28, 0x03 },
    /* car */ { 0x0F, 0x00, 0xFA, 0x28, 0x03 },
    0x00
};
